...
CREATE TABLE `users`(`first_name` varchar(50) DEFAULT NULL, `last_name` varchar(50) DEFAULT NULL, `username` varchar(50) NOT NULL, `id` int(11) NOT NULL AUTO_INCREMENT, `zipcode` int(11) DEFAULT NULL, `email` varchar(75) DEFAULT NULL, `password` varchar(250) DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `username_UNIQUE` (`username`));
